...
public:
	...
	////////////////////////////////////////////////////////////////////////////////
	int16_t Add(int32_t lSeq, int32_t lNum, int32_t* plCtrls, int32_t* plNumAdded)
	{
		int16_t sResult = 0;
		...
		*plNumAdded = 0;
		...
		int16_t Add(int32_t lSeq, int32_t lCtrl)
		{
			int16_t sResult = 0;
	...
	////////////////////////////////////////////////////////////////////////////////
	void DiscardThrough(int32_t lSeq)
	{
		if (m_lNumCtrls > 0)
		{
